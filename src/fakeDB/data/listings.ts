...
import { Listing, ListingType } from "../../types/graphql";

type ModifiedListing = Omit<
  Listing,
  "host" | "_id" | "bookingIndex" | "__typename" | "bookings"
>;
export type ListingDocumentType = ModifiedListing & {
  _id: ObjectID;
  host: string;
  bookingsIndex: any;
  bookings: ObjectID[];
...
export const listings: ListingDocumentType[] = [
  {
